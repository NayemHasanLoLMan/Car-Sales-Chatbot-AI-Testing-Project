...
#     """
#     Answer customer questions dynamically using LLaMA3.
#     The model uses the car JSON data as context.
#     """
#     try:
#         # Prepare the prompt for the LLaMA3 model
#         prompt = f"""
#         You are a knowledgeable car assistant. Use the following car details to answer customer questions:
...
#         Answer the question based on the car information. Be concise and accurate. If the question cannot be answered with the given data, let the customer know that the information is not available.
#         """

#         # Generate the response using the LLaMA3 model
